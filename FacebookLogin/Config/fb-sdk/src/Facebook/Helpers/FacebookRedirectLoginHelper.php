...
{
    /**
     * @const int The length of CSRF string to validate the fb-sdk link.
     */
    ...
    /**
     * Stores CSRF state and returns a URL to which the user should be sent to in order to continue the fb-sdk process with Facebook.
     *
     * @param string $redirectUrl The URL Facebook should redirect users to after fb-sdk.
     * @param array  $scope       List of permissions to request during fb-sdk.
    ...
    /**
     * Returns the URL to send the user in order to fb-sdk to Facebook.
     *
     * @param string $redirectUrl The URL Facebook should redirect users to after fb-sdk.
     * @param array  $scope       List of permissions to request during fb-sdk.
     * @param string $separator   The separator to use in http_build_query().
    ...
    /**
     * Returns the URL to send the user in order to fb-sdk to Facebook with permission(s) to be re-asked.
     *
     * @param string $redirectUrl The URL Facebook should redirect users to after fb-sdk.
     * @param array  $scope       List of permissions to request during fb-sdk.
     * @param string $separator   The separator to use in http_build_query().
    ...
    /**
     * Returns the URL to send the user in order to fb-sdk to Facebook with user to be re-authenticated.
     *
     * @param string $redirectUrl The URL Facebook should redirect users to after fb-sdk.
     * @param array  $scope       List of permissions to request during fb-sdk.
     * @param string $separator   The separator to use in http_build_query().
    ...
    /**
     * Takes a valid code from a fb-sdk redirect, and returns an AccessToken entity.
     *
