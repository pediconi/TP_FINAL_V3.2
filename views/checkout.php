  ...
  <div class="tm-main">
    ...
    <div class="container">
      <div class="tm-search-form-container">
        <form action="index.html" method="GET" class="form-inline tm-search-form __flex-center">
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                    ...
                    <tbody>
                        <?php if (!empty($purchaseLines)){
                             ...
                             foreach ($purchaseLines as $key => $value) { ?>
                                <tr>
                                    <td><?= $value->getEventSeat()->getCalendar()->getEvent()->getName() ?> | <?= $value->getEventSeat()->getSeatType()->getName() ?><strong class="mx-2">x</strong> <?= $value->getQuantity() ?></td>
                                    <td><?= $value->getTotal() ?></td>
                                </tr>
                                <?php $total = $total + $value->getTotal() ?>
                      <?php } 
                            } else {
                                echo '<h4> NO Tickets TO SHOW! </h4>';
                            }	?>	
                      <tr>
                  ...
                  <form action="<?= FRONT_ROOT ?>purchaseLine/addToDB" method="POST">
                    <input type="number" name="id" value="<?= $account->getId() ?>" hidden>
                    <input type="text" name="email" value="<?= $account->getEmail() ?>" hidden>
                    <div class="form-group">
