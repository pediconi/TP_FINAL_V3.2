      ...
      <div id="next-container" class="container text-center tm-background-container">
        <div class="tm-background">
          <main>
            <section class="mb-5">
                <div class="container">
                    <h2 class="mb-4">Add Seat Type</h2>
                    <form class="bg-light-alpha p-5" action="<?= FRONT_ROOT ?> seatType/add" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 id="mymodal" class="modal-title" id="exampleModalLongTitle">Edit Seat Type</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div id="mymodal" class="modal-body">
                        <form id="form" action="<?= FRONT_ROOT ?> seatType/modify" method="POST" enctype="multipart/form-data">
                          <div class="form-group">
                              <label for="">Id</label>
            ...
            <?php } else {
                      echo '<h4> NO Seat Types LOADED. </h4>';
                  } ?>
