...
-->
  ...
  <link rel="stylesheet" href="<?= CSS_PATH ?>bootstrap.min.css">                                            <!-- https://getbootstrap.com/ -->
  <link rel="stylesheet" href="<?= CSS_PATH ?>fontawesome-all.min.css">                                      <!-- Font awesome -->
  <link rel="stylesheet" href="<?= CSS_PATH ?>tooplate-style.css">                                           <!-- Templatemo style -->
          ...
          <div class="col-xl-12">
            <nav class="navbar navbar-expand-sm">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <a href="login.php" class="nav-link tm-nav-link tm-text-white">Login</a>
                </li>
              </ul>
            </nav>
          </div>
