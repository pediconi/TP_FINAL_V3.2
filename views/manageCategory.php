          ...
          <main>
            <section class="mb-5">
              <div class="container">
                ...
                <form class="bg-light-alpha p-5" action="<?= FRONT_ROOT ?> category/add" method="POST" enctype="multipart/form-data">
            ...
            <section class="mb-5">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 id="mymodal" class="modal-title" id="exampleModalLongTitle">Edit Category</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div id="mymodal" class="modal-body">
                      <form id="form" action="<?= FRONT_ROOT ?> category/modify" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                          <label for="">Id</label>
              ...
              <?php } else {
                        echo '<h4> NO CATEGORIES LOADED. </h4>';
                    } ?>
            </div>
          </div>
        </div>
